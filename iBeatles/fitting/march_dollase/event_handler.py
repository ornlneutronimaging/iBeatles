...
class EventHandler:
    ...
    def column_value_table_clicked(self, column):
        ...
        self.grand_parent.fitting_ui.ui.value_table.setRangeSelected(range_selected,
    ...
    def active_button_state_changed(self, row_clicked):
        ...
        self.parent.mirror_state_of_widgets(column=3,
    ...
    def mirror_state_of_widgets(self, column=2, row_clicked=0):
        ...
        o_table_handler = TableDictionaryHandler(grand_parent=self.grand_parent,
                                                 parent=self.parent)
    ...
    def lock_button_state_changed(self, status, row_clicked):
        ...
        o_filling_handler = FillingTableHandler(grand_parent=self.grand_parent,
                                                parent=self.parent)
