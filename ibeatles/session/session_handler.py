    ...
    session_dict = {SessionSubKeys.config_version: None,
                    ...
                    DataType.fitting: {SessionSubKeys.lambda_range_index: None,
                                       ...
                                       SessionSubKeys.kropff: {KropffSessionSubKeys.table_dictionary: None,
                                                  KropffSessionSubKeys.high_tof: {KropffSessionSubKeys.a0: '1',
                                                               KropffSessionSubKeys.b0: '1',
                                                               KropffSessionSubKeys.graph: 'a0',
                                                               },
                                                  KropffSessionSubKeys.low_tof: {KropffSessionSubKeys.ahkl: '1',
                                                              KropffSessionSubKeys.bhkl: '1',
                                                              KropffSessionSubKeys.graph: 'ahkl',
                                                              },
                                                  KropffSessionSubKeys.bragg_peak: {KropffSessionSubKeys.lambda_hkl: '5e-8',
                                                  ...
                                                  KropffSessionSubKeys.kropff_bragg_peak_good_fit_conditions:
                                                      {KropffSessionSubKeys.l_hkl_error: {KropffSessionSubKeys.state: True,
                                                                       KropffSessionSubKeys.value: 0.01},
                                                       KropffSessionSubKeys.t_error: {KropffSessionSubKeys.state: True,
                                                                   KropffSessionSubKeys.value: 0.01},
                                                       KropffSessionSubKeys.sigma_error: {KropffSessionSubKeys.state: True,
                                                                       KropffSessionSubKeys.value: 0.01},
                                                       },
                                                  KropffSessionSubKeys.kropff_lambda_settings: {KropffSessionSubKeys.state: 'fix',
                                                                             KropffSessionSubKeys.fix: 5e-8,
                                                                             KropffSessionSubKeys.range: [1e-8, 1e-7, 1e-8],
                                                                             },
                                                  KropffSessionSubKeys.bragg_peak_row_rejections_conditions: {KropffSessionSubKeys.l_hkl: {KropffSessionSubKeys.less_than: {KropffSessionSubKeys.state: True,
                                                                                                                   KropffSessionSubKeys.value: 0,
                                                                                                                   },
                                                                                                     KropffSessionSubKeys.more_than: {KropffSessionSubKeys.state: True,
