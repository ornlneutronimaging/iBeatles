...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.time_spectra_text = QtGui.QTextEdit(self.splitter)
        ...
        self.time_spectra_text.setObjectName(_fromUtf8("time_spectra_text"))
        self.time_spectra_plot = MPLWidget(self.splitter)
        self.time_spectra_plot.setObjectName(_fromUtf8("time_spectra_plot"))
