...
class SaveBinTab(SaveTab):
    ...
    def bin(self):
        ...
        formated_binning_line_view = []
        for _entry in binning_line_view:
            _value1, _value2 = _entry
            formated_binning_line_view.append([int(_value1), int(_value2)])
        ...
        self.session_dict['bin']['binning line view'] = list(formated_binning_line_view)
