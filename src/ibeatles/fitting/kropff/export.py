...
class Export:
    ...
    def export_table(self, file_type: FileType = FileType.ascii):
        ...
        if output_folder:
            self.export_with_specified_file_type(
                file_type=file_type, output_folder=output_folder
            )

    def export_with_specified_file_type(
        self, file_type: FileType = FileType.ascii, output_folder: str = None
    ):
